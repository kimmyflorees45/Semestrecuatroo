...
<form action="ingresar_datos.php" method="post">
    <div class="form-group">
        ...
        <input type="text" id="años" name="años" required><br>

        <label for="director">Director:</label>
        <input type="text" id="director" name="director" required><br>

        <label for="act">Actores:</label>
        <input type="text" id="act" name="act" required><br>

        <label for="Personajes">Personajes:</label>
        <input type="text" id="Personajes" name="Personajes" required><br>  
