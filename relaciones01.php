...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <p style="text-align:center; margin: 10px 0;">
        <a class="btn btn-info" href="capturadatosrelacionados - copia.php">Ir a Capturar Datos Relacionados</a>
    </p>
    ...
    $sql = "SELECT 
                ...
                p.nombre AS Nombre, 
                p.Alias AS Alias, 
                p.FechaCreacion AS `Fecha De Creacion`, 
                p.descripcion AS Descripcion,
                c.titulo AS `titulo del comic`, 
                s.nombre AS `Nombre del superheroe`
            FROM personajes p
    ...
    if($resultado && $resultado->num_rows > 0){
        ...
        echo "<tr>
         ...
         while($row = $resultado->fetch_assoc()){
             ...
             echo "<td>" . $row["titulo del comic"] . "</td>";
             echo "<td>" . $row["Nombre del superheroe"] . "</td>";
             echo "</tr>";
         }
         echo "</table>"; 
     } else {
         echo "<p style='text-align:center;'>No se encontraron personajes registrados o error: " . $conexion->error . "</p>";
     }
